...
import { RobotTurtleGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface RobotTurtleGameProps {
  config: RobotTurtleGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function RobotTurtleGame({ config, onComplete, backUrl }: RobotTurtleGameProps) {
  return (
