...
import { SpeedTyperGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface SpeedTyperGameProps {
  config: SpeedTyperGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function SpeedTyperGame({ config, onComplete, backUrl }: SpeedTyperGameProps) {
  return (
