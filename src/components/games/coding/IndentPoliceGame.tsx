...
import { IndentPoliceGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface IndentPoliceGameProps {
  config: IndentPoliceGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function IndentPoliceGame({ config, onComplete, backUrl }: IndentPoliceGameProps) {
  return (
