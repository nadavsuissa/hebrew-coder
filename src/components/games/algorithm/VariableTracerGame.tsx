...
import { VariableTracerGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface VariableTracerGameProps {
  config: VariableTracerGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function VariableTracerGame({ config, onComplete, backUrl }: VariableTracerGameProps) {
  return (
