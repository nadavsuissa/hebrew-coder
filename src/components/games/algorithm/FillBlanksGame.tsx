...
import { FillBlanksGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface FillBlanksGameProps {
  config: FillBlanksGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function FillBlanksGame({ config, onComplete, backUrl }: FillBlanksGameProps) {
  return (
