...
import { OutputPredictorGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface OutputPredictorGameProps {
  config: OutputPredictorGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function OutputPredictorGame({ config, onComplete, backUrl }: OutputPredictorGameProps) {
  return (
