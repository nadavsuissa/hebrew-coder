...
import { SliceMasterGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface SliceMasterGameProps {
  config: SliceMasterGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function SliceMasterGame({ config, onComplete, backUrl }: SliceMasterGameProps) {
  return (
