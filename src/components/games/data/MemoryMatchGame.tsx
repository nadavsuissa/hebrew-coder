...
import { MemoryMatchGameConfig, GameCompletionCallback } from '@/types/games';
import { GameContainer } from '../shared/GameContainer';

interface MemoryMatchGameProps {
  config: MemoryMatchGameConfig;
  onComplete: GameCompletionCallback;
  backUrl?: string;
}

export function MemoryMatchGame({ config, onComplete, backUrl }: MemoryMatchGameProps) {
  return (
